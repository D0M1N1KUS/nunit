...
namespace NUnit.AssertPackage
{
    public abstract partial class Assert
    {
        ...
        {
            AssertPackage.Assert.That(actual, Is.AssignableFrom(expected) ,message, args);
        }
        ...
        {
            AssertPackage.Assert.That(actual, Is.AssignableFrom(expected) ,null, null);
        }
        ...
        {
            AssertPackage.Assert.That(actual, Is.AssignableFrom(typeof(TExpected)) ,message, args);
        }
        ...
        {
            AssertPackage.Assert.That(actual, Is.AssignableFrom(typeof(TExpected)) ,null, null);
        }
        ...
        {
            AssertPackage.Assert.That(actual, Is.Not.AssignableFrom(expected) ,message, args);
        }
        ...
        {
            AssertPackage.Assert.That(actual, Is.Not.AssignableFrom(expected) ,null, null);
        }
        ...
        {
            AssertPackage.Assert.That(actual, Is.Not.AssignableFrom(typeof(TExpected)) ,message, args);
        }
        ...
        {
            AssertPackage.Assert.That(actual, Is.Not.AssignableFrom(typeof(TExpected)) ,null, null);
        }
        ...
        {
            AssertPackage.Assert.That(actual, Is.InstanceOf(expected) ,message, args);
        }
        ...
        {
            AssertPackage.Assert.That(actual, Is.InstanceOf(expected) ,null, null);
        }
        ...
        {
            AssertPackage.Assert.That(actual, Is.InstanceOf(typeof(TExpected)) ,message, args);
        }
        ...
        {
            AssertPackage.Assert.That(actual, Is.InstanceOf(typeof(TExpected)) ,null, null);
        }
        ...
        {
            AssertPackage.Assert.That(actual, Is.Not.InstanceOf(expected) ,message, args);
        }
        ...
        {
            AssertPackage.Assert.That(actual, Is.Not.InstanceOf(expected) ,null, null);
        }
        ...
        {
            AssertPackage.Assert.That(actual, Is.Not.InstanceOf(typeof(TExpected)) ,message, args);
        }
        ...
        {
            AssertPackage.Assert.That(actual, Is.Not.InstanceOf(typeof(TExpected)) ,null, null);
        }
