...
namespace NUnit.AssertPackage
{
    ...
    public abstract class CollectionAssert
    {
        ...
        {
            AssertPackage.Assert.That(collection, Is.All.InstanceOf(expectedType), message, args);
        }
        #endregion
        ...
        {
            AssertPackage.Assert.That(collection, Is.All.Not.Null, message, args);
        }
        #endregion
        ...
        {
            AssertPackage.Assert.That(collection, Is.Unique, message, args);
        }
        #endregion
        ...
        {
            AssertPackage.Assert.That(actual, Is.EqualTo(expected).AsCollection, message, args);
        }
        ...
        {
            AssertPackage.Assert.That(actual, Is.EqualTo(expected).Using(comparer), message, args);
        }
        #endregion
        ...
        {
            AssertPackage.Assert.That(actual, Is.EquivalentTo(expected), message, args);
        }
        #endregion
        ...
        {
            AssertPackage.Assert.That(actual, Is.Not.EqualTo(expected).AsCollection, message, args);
        }
        ...
        {
            AssertPackage.Assert.That(actual, Is.Not.EqualTo(expected).Using(comparer), message, args);
        }
        #endregion
        ...
        {
            AssertPackage.Assert.That(actual, Is.Not.EquivalentTo(expected), message, args);
        }
        #endregion
        ...
        {
            AssertPackage.Assert.That(collection, Has.Member(actual), message, args);
        }
        #endregion
        ...
        {
            AssertPackage.Assert.That(collection, Has.No.Member(actual), message, args);
        }
        #endregion
        ...
        {
            AssertPackage.Assert.That(subset, Is.Not.SubsetOf(superset), message, args);
        }
        #endregion
        ...
        {
            AssertPackage.Assert.That(subset, Is.SubsetOf(superset), message, args);
        }
        #endregion
        ...
        {
            AssertPackage.Assert.That(superset, Is.Not.SupersetOf(subset), message, args);
        }
        #endregion
        ...
        {
            AssertPackage.Assert.That(superset, Is.SupersetOf(subset), message, args);
        }
        #endregion
        ...
        {
            AssertPackage.Assert.That(collection, new NotConstraint(new EmptyCollectionConstraint()), message, args);
        }
        ...
        {
            AssertPackage.Assert.That(collection, Is.Ordered, message, args);
        }
        ...
        {
            AssertPackage.Assert.That(collection, Is.Ordered.Using(comparer), message, args);
        }
